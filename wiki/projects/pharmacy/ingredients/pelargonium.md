...
Umcka ColdCare — confirmed per its own DailyMed label, pulled 2026-08-26 during brand-page research: active ingredient listed as "Pelargonium sidoides 1X," directions 1.5mL by mouth 3x daily for adults/children ≥12y (see `drugs/Umcka ColdCare.md`). Umcka Cold+Flu — confirmed per its own DailyMed label (also 2026-08-26): a genuinely different, more complex formulation than ColdCare — pelargonium sidoides combined with SEVEN additional true homeopathic-dilution ingredients (aconitum napellus, bryonia, eucalyptus globulus, eupatorium perfoliatum, gelsemium sempervirens, ipecacuanha, phosphorus) in one chewable product (see `drugs/Umcka Cold+Flu.md`). Nature's Way Umcka ColdCare Kids — confirmed (2026-08-27 brand-page research) via manufacturer labeling: Pelargonium sidoides 1X syrup, ages 1+, marketed "phenylephrine free" — same 1X dose-equivalence gap as ColdCare/Cold+Flu above applies unresolved to this pediatric variant. See `drugs/Nature's Way Umcka ColdCare Kids.md`.

## Brand-Specific Notes
**Labeling discrepancy, not a factual contradiction — flagged rather than silently resolved:** This page's header explicitly states pelargonium is "NOT a homeopathic dilution" and frames it as a pharmacologically active standardized extract (EPs 7630) with real dose-finding and meta-analysis RCT evidence behind it. However, Umcka ColdCare's actual FDA-registered DailyMed label lists the active ingredient using homeopathic-style dilution notation: **"Pelargonium sidoides 1X"** (a 1:10 dilution under the Homeopathic Pharmacopoeia convention). Both things can be true simultaneously — this page's own Regulatory Note precedent on [[zinc]] (Cold-EEZE's "2X" zinc gluconate label) already establishes that "X"-notation products can still deliver a real, non-trivial dose of active compound; it is not automatically evidence of homeopathic-style ultra-dilution. That said, this page does not currently know how much standardized EPs 7630 material a "1X" Umcka dose actually corresponds to in mg terms, so the practical equivalence between Umcka's labeled 1X dose and the 30-90mg/day EPs 7630 doses used in the Matthys 2010 dose-finding RCT above has **not been established** — this is a real gap, not just a labeling footnote, and should be resolved before treating Umcka's dosing as backed by that specific trial's evidence.

**Extended by Umcka Cold+Flu (brand-page research, 2026-08-26):** this tension is more pronounced for Umcka Cold+Flu, which genuinely does combine pelargonium with seven true homeopathic-dilution remedies in one product — a materially more "homeopathic-leaning" formulation than ColdCare's near-single-ingredient profile. The same unresolved dose-equivalence gap applies, arguably more acutely: this page cannot currently confirm what fraction of Umcka Cold+Flu's effect (if any) is attributable to its pelargonium content specifically, versus its other seven ingredients. Within the same brand family, "Umcka" therefore spans a real spectrum from mostly-pelargonium to pelargonium-plus-several-homeopathic-remedies — do not treat all Umcka SKUs as evidentially equivalent.
