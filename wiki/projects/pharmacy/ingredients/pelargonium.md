...
Umcka ColdCare — confirmed per its own DailyMed label, pulled 2026-08-26 during brand-page research: active ingredient listed as "Pelargonium sidoides 1X," directions 1.5mL by mouth 3x daily for adults/children ≥12y (see `drugs/Umcka ColdCare.md`). Umcka Cold+Flu, Nature's Way Umcka ColdCare Kids — named directly in this database's Pharmacy Times category tables; the pediatric "Kids" variant's exact dose/formulation is not separately verified here.
