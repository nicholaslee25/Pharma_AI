...
**Colgate confirmed 2026-08-27:** Colgate Cavity Protection paste uses **sodium monofluorophosphate 0.76%** (0.15% w/v fluoride ion) per DailyMed — a different fluoride salt than sodium fluoride, though delivering the same fluoride-ion concentration; the gel variant instead uses sodium fluoride 0.24%. Separately, Colgate Total is confirmed stannous-fluoride based, the same multi-formulation-under-one-brand pattern seen with Crest. See `drugs/Colgate.md`. **Aquafresh confirmed 2026-08-27:** Cavity Protection and related whitening/multi-action lines confirmed sodium fluoride 0.25% per DailyMed, consistently across sub-lines checked (unlike Crest/Colgate's split). See `drugs/Aquafresh.md`. **Arm & Hammer confirmed 2026-08-27, with a marketing-vs-label discrepancy:** Complete Care Whole Mouth Protection is confirmed sodium fluoride 0.24% as the sole FDA active ingredient — the brand's namesake baking soda (sodium bicarbonate) appears only as an INACTIVE ingredient on this SKU, the same active/marketed-ingredient mismatch pattern documented for CloSYS. See `drugs/Arm & Hammer.md`. Tom's of Maine — plausible fluoride-toothpaste brands by real-world market identity and category placement, though most major brands also sell fluoride-free variants (especially Tom's of Maine, which markets both), so fluoride content should be confirmed per specific SKU rather than assumed from brand name alone. **Biotène toothpaste (Fresh Mint Original/Gentle Mint) confirmed sodium fluoride paste per its own DailyMed label** (2026-08-26) — but note Biotène's much larger oral-RINSE product lines (Dry Mouth, PBF) show no identified Drug Facts panel at all, a cosmetic/drug split within the same brand; see `drugs/Biotène.md` and [[saliva-substitutes]]. **Tom's of Maine confirmed to span both classifications (2026-08-26):** Whole Care Mouthwash and Children's Anticavity Rinse are confirmed sodium fluoride (0.02% and 0.04% respectively), while the separate "Wicked Fresh!" mouthwash line is explicitly fluoride-free and cosmetic-classified (zinc-based odor neutralization, no located Drug Facts panel) — see `drugs/Tom's of Maine.md`. **Crest confirmed 2026-08-27:** Crest Cavity Protection and 3D White lines are sodium fluoride 0.243% per DailyMed — but the same "Crest" master brand's Pro-Health sub-line is a materially different active ingredient (stannous fluoride, see [[stannous-fluoride]] and `drugs/Crest Pro-Health.md`), the same multi-formulation-under-one-name pattern seen elsewhere in this database. **hello confirmed 2026-08-27:** core line (Penguin Chill, Vitamin C Whitening, Magical Mermaid, Unicorn Sparkle, Dragon Dazzle) uses sodium fluoride 0.24% per DailyMed; the Mighty Multi-Tasker sub-line is stannous fluoride instead (same multi-formulation pattern). **Two brand-specific safety events flagged (unrelated to the ingredient itself):** a confirmed 2023-08-10 Colgate-Palmolive voluntary recall (182,046 tubes) of hello Wild Strawberry Fluoride Toothpaste mislabeled as fluoride-FREE Fresh Watermelon; and a separate, unresolved 2025-07-11 federal class-action lawsuit alleging lead/mercury contamination in two Hello Kids products, not confirmed by any FDA action as of this pass. See `drugs/hello.md` for full detail and hedging. **Children's Mouthwashes confirmed 2026-08-27:** ACT Kids Anticavity (sodium fluoride 0.05%, 0.02% w/v fluoride ion) and Colgate Kids (sodium fluoride 0.02%, 0.01% w/v fluoride ion) — a real, roughly 2x fluoride-concentration difference between this category's two leading brands. Colgate Kids also lists cetylpyridinium chloride as an inactive ingredient despite its real antimicrobial properties, a minor instance of the same active/marketed-ingredient labeling pattern seen with CloSYS and Arm & Hammer. See `drugs/ACT Kids Anticavity.md` and `drugs/Colgate Kids.md`. **Listerine Smart Rinse confirmed 2026-08-27:** matches Colgate Kids at sodium fluoride 0.02% (0.01% w/v fluoride ion), confirming a real two-tier fluoride-concentration split (0.02% vs. ACT Kids Anticavity's 0.05%) across this category's top three ranked brands. See `drugs/Listerine Smart Rinse.md`.
