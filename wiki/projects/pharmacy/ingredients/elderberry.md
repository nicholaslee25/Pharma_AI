...
**Correction/refinement (brand-page research, 2026-08-26): the statement above is only true for one of two distinct Sambucol SKUs, not the brand as a whole.** DailyMed shows "Sambucol" spans genuinely different formulations: **Sambucol Black Elderberry Original Syrup** is a real concentrated extract (16,720mg elderberries/serving) — the "not homeopathic despite the category label" framing applies to this product. But **"Sambucol Cold and Flu Relief"** (quick-dissolve tablets) is an *actual* homeopathic combination remedy — Bryonia 6X, Gelsemium Sempervirens 6X/12X/30X, Sambucus Nigra 3X/6X, Sulphur 12X, Zincum Gluconicum 2X/6X — where Sambucus/elderberry is only one of five ingredients, all at genuinely dilute homeopathic potency. For that SKU, the "categorization artifact, not actually homeopathic" claim is **wrong** — it is a real homeopathic product, and this ingredient page's RCT evidence (Hawkins 2019, Wieland 2021, both studying concentrated extract) does not meaningfully apply to it. See `drugs/Sambucol.md`, `drugs/Sambucol Cold & Flu Relief.md`, and `drugs/Sambucol Black Elderberry Cold & Flu Relief.md` for the full brand-level treatment. This database's Pharmacy Times source data does not specify which SKU underlies the "Sambucol" entries in Homeopathic Cough Products/Homeopathic Cold Products/Immune Support — treated as genuinely ambiguous rather than assumed.

**Extended finding (2026-08-27, Pediatrics/Children's Homeopathic Cough Products research): "Sambucol Homeopathic Cold & Flu"** (Children's Homeopathic Cough Products, 12% share) is very likely a FOURTH brand-name rendering of the same real-world homeopathic tablet product already documented above under three other names (Sambucol, Sambucol Cold & Flu Relief, Sambucol Black Elderberry Cold & Flu Relief). This is the most extensive same-product-multiple-names pattern identified in this database to date — see `drugs/Sambucol Homeopathic Cold & Flu.md`.
