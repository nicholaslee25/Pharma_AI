...
**Crest Pro-Health confirmed 2026-08-26:** multiple sub-lines (Clean Mint, base Pro-Health, Gum Detoxify Deep Clean, Maximum Cavity Protection, Advanced Antibacterial Protection) all confirmed stannous fluoride paste per their own DailyMed labels — see `drugs/Crest Pro-Health.md`. **Parodontax — discrepancy confirmed 2026-08-26:** the TOOTHPASTE line (Active Gum Repair, Complete Protection, etc.) is confirmed stannous fluoride, matching the brand's own "why parodontax uses stannous fluoride" marketing — but the SEPARATE Parodontax Active Gum Health Mouthwash is confirmed to use cetylpyridinium chloride (CPC) 0.07% w/w INSTEAD, not stannous fluoride at all. The brand's defining ingredient does not extend across its full product line. See `drugs/Parodontax.md`. **Crest Gum & Sensitivity confirmed 2026-08-27:** the "Toothpaste, Sensitive Gums/Teeth" category entry (Crest Pro-Health Sensitive and Gum / Gum and Sensitivity lines) is confirmed stannous fluoride 0.454%, marketed for anticavity + antigingivitis + antisensitivity — a genuine brand-specific RCT (Schiff et al., 8-week study) found statistically significant hypersensitivity reduction (Schiff Air Index, P<.0001 at weeks 4 and 8) vs. a sodium-fluoride control. This corrects [[potassium-nitrate]]'s prior placeholder assumption that Crest Gum & Sensitivity was potassium-nitrate-based — it is not; see `drugs/Crest Gum & Sensitivity.md`. **Sensodyne confirmed 2026-08-27:** the "Sensodyne Sensitivity, Gum & Enamel" sub-line is also confirmed stannous fluoride 0.454% (same triple anticavity/antigingivitis/antihypersensitivity purpose) — meaning even Sensodyne, this database's most strongly potassium-nitrate-associated brand (65% share of Toothpaste, Sensitive Gums/Teeth), is not exclusively potassium-nitrate based across its own product line. See `drugs/Sensodyne.md`.
