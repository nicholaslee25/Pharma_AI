...
Brand-page research (2026-08-26) has since pulled individual FDA labels for all 14 brands in this category. Confirmed genuine lubricant-active brands: **Systane** (PEG 400 + propylene glycol, combination), **Refresh** (carboxymethylcellulose sodium 0.5%, the representative label originally pulled for this page), **Blink** (PEG 400 0.25%), **GenTeal Tears** (dextran 70/glycerin/hypromellose — Moderate; hypromellose alone — Severe), **Tears Naturale** (dextran 70/glycerin/hypromellose, identical formulation to and same manufacturer — Alcon — as GenTeal Tears, effectively sibling products under two brand names), **Biotrue** eye-drop line (glycerin; its separate Contact Lens Solution line is an unrelated product), **Bausch + Lomb Advanced Eye Relief** (multiple sub-lines: glycerin+propylene glycol for Dry Eye, hypromellose+naphazoline for Maximum Redness), **Optase** (glycerin across its main drop lines), **TheraTears** (carboxymethylcellulose sodium 0.25% plus an electrolyte system), **Soothe** (varies by sub-line: povidone, glycerin+propylene glycol, or mineral oil for XP), **Retaine** (light mineral oil/mineral oil emulsion, MGD line).

**Discrepancy flagged — category-placement mismatch:** **Clear Eyes** and **Visine**'s flagship products are vasoconstrictor redness relievers (naphazoline, tetrahydrozoline) or redness-reliever/lubricant combinations, not lubricant-only formulations — a materially different pharmacology and safety profile (rebound hyperemia risk) that this page's lubricant-focused evidence does not address. See each brand's own page for detail. **No dedicated ingredient-evidence page for ophthalmic decongestants/vasoconstrictors exists yet in this project** — a gap to fill when the Ophthalmic Antihistamines/Decongestants EENT subcategory is researched directly.

**Discrepancy flagged — regulatory finding:** **iVizia** was determined by the FDA to be an unapproved drug — its labeled "inactive" ingredients (trehalose, sodium hyaluronate) were found to function as active pharmacological ingredients not permitted under the OTC ophthalmic demulcent monograph, while the company's own marketing described therapeutic effects for them. See [[iVizia]] for full detail; this is a real FDA compliance finding, not a generic formulation-comparison note like the others above.
