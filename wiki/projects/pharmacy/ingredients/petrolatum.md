...
**[[Vaseline]] confirmed 2026-08-27:** the bare "Vaseline" brand-file entry (Eczema Care/Relief 1%, Therapeutic Skin Care/Moisturizers 1%) is Unilever's "Vaseline Intensive Care Deep Moisture" lotion — confirmed via DailyMed, **white petrolatum USP 30%**, an actual FDA OTC skin-protectant drug (not a cosmetic). This is a real, lower-concentration formulation distinct from [[Vaseline Petroleum Jelly]] (tracked separately, near-100% pure petrolatum) — the two "Vaseline" brand-file entries in this database are meaningfully different products, not interchangeable despite the shared name. See `drugs/Vaseline.md`. Aquaphor is a petrolatum-containing combination product (not pure petrolatum) — its specific formulation was not independently tested in the RCT above and should not be assumed to have identical performance. **Aquaphor Baby confirmed 2026-08-27:** Healing Ointment is petrolatum 41% as its sole active ingredient (no lanolin, unlike A&D/A+D), correctly labeled for diaper rash prevention/treatment — a correct category match, in contrast to Calmoseptine's anorectal-labeled mismatch in the same Diaper Rash Products category. See `drugs/Aquaphor Baby.md`. **CeraVe Baby Healing Ointment confirmed 2026-08-27:** also petrolatum 41%, the exact same concentration as Aquaphor Baby — correcting [[zinc-oxide]]'s earlier general assumption that this brand was zinc-oxide-based. Explicitly lanolin-free and fragrance-free. See `drugs/CeraVe Baby Healing Ointment.md`.

**Discrepancy flagged (2026-08-26, First Aid/Burn Treatments brand-page research): [[A+D First Aid Ointment]] and [[A&D]]** — both confirmed via DailyMed to be **lanolin 15.5% + petrolatum 53.4%** skin-protectant ointments, per their own FDA labels. Both are filed elsewhere in this database under antimicrobial/pain-relief categories (Burn Treatments and Topical Antibiotics/Antiseptics respectively) despite containing no antibiotic, antiseptic, or anesthetic ingredient — their actual mechanism is this page's occlusive moisture-barrier effect, not infection prevention or pain relief. See [[burn-treatment]] and [[topical-antibiotics]] for the category-placement discrepancy. **Third category appearance confirmed (2026-08-27): [[A+D Original Ointment]]** (Diaper Rash Products, 14% share) is this same lanolin+petrolatum product's third listing in this database — and unlike the other two, this one is a correct mechanism match, since diaper rash prevention/treatment is the product's own primary FDA-labeled indication. **Fourth appearance confirmed (2026-08-27): [[A+D Ointment]]** (Incontinence-Related Skin Protectants, 17% share) — also a correct mechanism match, same reasoning as the Diaper Rash Products appearance.
