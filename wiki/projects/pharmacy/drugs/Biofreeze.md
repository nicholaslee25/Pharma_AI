...
- Menthol counterirritant mechanism is genuinely different from the lidocaine (numbing) and capsaicin (substance-P depletion) options in the same category, giving patients a real mechanistic choice if one approach doesn't suit them
- Available across a wide range of formats (spray, cream, gel, roll-on), supporting different application preferences
...
## Allergies / Warnings
For external use only; avoid eyes and mucous membranes; do not apply to wounds or damaged skin; do not bandage tightly or use with a heating pad. Stop use and ask a doctor if condition worsens or symptoms persist beyond 7 days. No diabetes-specific contraindication identified, though the general caution about diminished sensation in neuropathy patients masking overuse/skin-reaction warning signs (already noted on [[Capzasin]]'s page) applies similarly here.
